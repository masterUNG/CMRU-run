...
public class ExerciseActivity extends AppCompatActivity {
    ...
    public void clickAnswer(View view) {
        ...
        if (checkChoose()) {
            ...
            myAlert.myDialog(this, "ไม่ตอบคำถาม",
                    "กรุณาตอบคำถาม");
    ...
    private void checkUserScore() {
        ...
        if (scoreAnInt >= 3) {
            //Update Gold
            Toast.makeText(this, "ยินดีด้วยคุณผ่านด่านแว้ววว", Toast.LENGTH_SHORT).show();
            editGoldOnServer();

        } else {
            //Play Again
            Toast.makeText(this,
                    "คะแนนของคุณ " + Integer.toString(scoreAnInt) + " คะแนน ต้องเล่นใหม่",
